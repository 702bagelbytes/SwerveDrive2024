...
public class AutoPickUpCommand extends Command {
  ...
  public AutoPickUpCommand(DoubleSupplier tx, DoubleSupplier ta, BooleanSupplier tv, Swerve s_Swerve, double turn) {
    this.ta = ta;
    this.tx = tx;
    this.tv = tv;
  ...
  public void execute() {
    ...
    double FollowPID = (Target ? MathUtil.clamp(result, -0.20, 0.20) : 0);
